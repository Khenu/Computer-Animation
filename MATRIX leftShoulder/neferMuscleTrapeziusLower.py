# neferMuscleTrapeziusLower.py
# Created by Laushon Neferkara on 3/10/14.
...
Also run: 
poseReoganization3.py
addPoseVisibilityCtrl.py
'''
...
def main():
	...
	muscle = NeferMuscle('L_trapeziusO', 4, n3driver)
	muscle = NeferMuscle('L_trapeziusP', 4, n3driver)
	muscle = NeferMuscle('L_trapeziusQ', 4, n3driver)
	muscle = NeferMuscle('L_trapeziusR', 4, n3driver)
	muscle = NeferMuscle('L_trapeziusS', 4, n3driver)
