# neferMuscle_brachialis.py
# Created by Laushon Neferkara on 8/18/13.
...
def main():
	scriptName = 'neferMuscle_brachialis.py'
	print '\r' + scriptName + ' running'

	nDriver = Driver(
		'N3_brachialis_driver', 
		(('x0', 'x45', 'x90', 'x135', 'x180', 'xn45'), 
		('y0', 'y90', 'y170'))
		)

	muscle = NeferMuscle('L_brachialisA', nDriver)
