# neferMusclePectoralis.py
# Created by Laushon Neferkara on 2/17/14.
...
class NeferMuscle():
	'''Represents a neferMuscle: a Maya Muscle that is controlled by a multi-variable
	 pose controller.'''
	def __init__(self, muscleName, numCtrls, driverInfo):
		self.muscleName = muscleName
...
def main():
	...
	muscle = NeferMuscle('L_pectoralisA', 6, n3driver)
	muscle = NeferMuscle('L_pectoralisB', 6, n3driver)
	muscle = NeferMuscle('L_pectoralisC', 6, n3driver)
	muscle = NeferMuscle('L_pectoralisD', 6, n3driver)
	muscle = NeferMuscle('L_pectoralisE', 6, n3driver)
	muscle = NeferMuscle('L_pectoralisF', 6, n3driver)
	muscle = NeferMuscle('L_pectoralisG', 6, n3driver)
	muscle = NeferMuscle('L_pectoralisH', 6, n3driver)
	muscle = NeferMuscle('L_pectoralisJ', 6, n3driver)
	muscle = NeferMuscle('L_pectoralisK', 7, n3driver)
	muscle = NeferMuscle('L_pectoralisL', 7, n3driver)
	muscle = NeferMuscle('L_pectoralisM', 7, n3driver)
