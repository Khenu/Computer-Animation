# neferMuscleTeresMajor.py
# Created by Laushon Neferkara on 10/15/13.
...
class NeferMuscle():
	'''Represents a neferMuscle: a Maya Muscle that is controlled by a multi-variable
	 pose controller.'''
	def __init__(self, muscleName, numCtrls, driverInfo, crossSections):
		self.muscleName = muscleName
...
def main():
	...
	# muscle = NeferMuscle('L_teresMajor', 5, n3driver)
	# muscle = NeferMuscle('L_teresMinor2', 5, n3driver)
	# muscle = NeferMuscle('L_infraspinatusA', 5, n3driver, crossSections=False)
	# muscle = NeferMuscle('L_infraspinatusB', 5, n3driver, crossSections=False)
	muscle = NeferMuscle('L_infraspinatusC', 5, n3driver, crossSections=False)
