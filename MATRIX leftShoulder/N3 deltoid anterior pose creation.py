# N3 deltoid anterior pose creation.py
# Created by Laushon Neferkara on 3/21/13.
...
scriptName = 'N3 deltoid pose creation.py'
...
# Muscle
muscle = 'deltoid'
muscleNode = 'cMuscleCreatorMus_deltoid_B1'
