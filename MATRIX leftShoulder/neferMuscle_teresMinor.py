...
def main():
	...
	# muscle = NeferMuscle('L_teresMinor', nDriver)
	muscle = NeferMuscle('L_coracobrachialis', nDriver)

	print '\r\rScripte completed Successfully\r\r'
